		...
		<div class="relative mt-2 px-6 pb-20 pt-16 sm:pt-32 lg:static lg:px-8 lg:py-48">
			<div class="mx-auto max-w-xl lg:mx-0 lg:max-w-lg">
				...
				<!-- <p class="mt-6 text-lg/8 text-gray-300">
					...
					получите бонус до 5% от стоимости покупки.
				</p> -->
				<!-- <p class="mt-2 text-lg/8 text-gray-300">
					Или станьте зарегистрированным пользователем и получите до 5% кэшбэк, если приобретаете
					для себя.
				</p> -->
			...
			<div class="mx-auto max-w-xl lg:mr-0 lg:max-w-lg">
				<div class="grid grid-cols-1 gap-x-8 gap-y-6 sm:grid-cols-2">
					...
					<div class="sm:col-span-2">
						<label for="position" class="block text-sm/6 font-semibold text-white"
							>Изделие, которым интересуется клиент</label
						>
						<div class="mt-2.5">
							<input
								type="text"
					...
					<div class="sm:col-span-2">
						...
						<div class="mt-2.5">
							<textarea
								name="message"
								id="message"
								placeholder="Например, в какую компанию нам не следует обращаться, на какой бюджет настроен клиент и пр."
								rows="4"
								class="block w-full rounded-md bg-white/5 px-3.5 py-2 text-base text-white outline outline-1 -outline-offset-1 outline-white/10 placeholder:text-gray-500 focus:outline focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-500"
							></textarea>
						</div>
